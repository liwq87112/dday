...
- (void)configCollectionView {
    ...
    layout.itemSize = CGSizeMake(_itemWH, _itemWH+20);
    layout.minimumInteritemSpacing = _margin;
    layout.minimumLineSpacing = _margin;
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, self.lpd_width, self.lpd_height+20) collectionViewLayout:layout];
